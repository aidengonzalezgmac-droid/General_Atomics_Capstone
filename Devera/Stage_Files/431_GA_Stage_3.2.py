...
# graphite armor tiling will contribute heavily to this

AmbientT = 294 # in Kelvin, # ambient 70 deg Fahrenheit
SupercondT = 4 # in Kelvin # Nuclear data doesn't have CS for copper interactions at superconducting temps.
...
# <<<<<<<<<<<< MANUALLY SET TO CARBON 12 >>>>>>>>>>>> IN MATERIALS FILE FOR CS TESTING.
...
# based on math derived from the link above and from source code for 
...
Diagnostic_position1 = [-874.4,  940,     0]
