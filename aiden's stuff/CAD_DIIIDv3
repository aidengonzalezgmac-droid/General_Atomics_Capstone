...
# Intermediate ingredients for the mix
...
wall_concrete = openmc.Material.mix_materials([_concrete, _barite], [0.85, 0.15], 'wo')
wall_concrete.name = 'Concrete(0.85)-Barite(0.15)'  
...
mats = openmc.Materials([inconel, wall_shielding, structural_steel, wall_concrete, roof_shielding, air, void])
mats.export_to_xml()
