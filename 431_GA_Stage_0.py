...
Stage_0_Model = openmc.DAGMCUniverse(filename = '/bin/431_GA_Stage_0.6.h5m', auto_geom_ids = True)
room = openmc.Cell(name = 'Machine_Hall')
room.fill = Stage_0_Model

geometry = openmc.Geometry([room])
...
plot.colors = {
    Wall_Concrete:'grey', 
    Structural_Steel:'blue',
    Inconel:'red',
    Roof_Shielding:'green',
    Wall_Shielding:'purple',
    Air:'white',
    Void:'black'
}
